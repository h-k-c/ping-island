...
final class ProcessTreeBuilderTests: XCTestCase {
    func testFindInteractiveSSHCarrierMatchesRemoteHostHint() {
        let tree: [Int: Auralink.ProcessInfo] = [
            100: Auralink.ProcessInfo(pid: 100, ppid: 1, command: "/Applications/Ghostty.app/Contents/MacOS/ghostty", tty: "ttys001"),
            110: Auralink.ProcessInfo(pid: 110, ppid: 100, command: "/bin/zsh -l", tty: "ttys001"),
            120: Auralink.ProcessInfo(pid: 120, ppid: 110, command: "/usr/bin/ssh devbox", tty: "ttys001"),
            200: Auralink.ProcessInfo(pid: 200, ppid: 1, command: "/Applications/Ghostty.app/Contents/MacOS/ghostty", tty: "ttys002"),
            210: Auralink.ProcessInfo(pid: 210, ppid: 200, command: "/bin/zsh -l", tty: "ttys002"),
            220: Auralink.ProcessInfo(pid: 220, ppid: 210, command: "/usr/bin/ssh otherbox", tty: "ttys002")
        ]
    ...
    func testFindInteractiveSSHCarrierReturnsNilWhenHostMatchIsAmbiguous() {
        let tree: [Int: Auralink.ProcessInfo] = [
            100: Auralink.ProcessInfo(pid: 100, ppid: 1, command: "/Applications/Utilities/Terminal.app/Contents/MacOS/Terminal", tty: "ttys001"),
            110: Auralink.ProcessInfo(pid: 110, ppid: 100, command: "/usr/bin/ssh devbox", tty: "ttys001"),
            200: Auralink.ProcessInfo(pid: 200, ppid: 1, command: "/Applications/Ghostty.app/Contents/MacOS/ghostty", tty: "ttys002"),
            210: Auralink.ProcessInfo(pid: 210, ppid: 200, command: "/usr/bin/ssh user@devbox", tty: "ttys002")
        ]
